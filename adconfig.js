...
window.adUnits = {
  // --- Display Ads ---
  //slot1: '/23353868385/champslevl.com_d1',   // Top banner
  //slot2: '/23353868385/champslevl.com_d2',   // Mid banner (question ke neeche)
  //// --- Rewarded Ad ---
  reward: '/23353868385/champslevl.com_reward',

  // --- Interstitial (agar use ho) ---
  // interstitial: '/23353868385/champslevl.com_interstitial',
